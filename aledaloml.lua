...
function library:Watermark(text)
    ...
    edge.BackgroundColor3 = Color3.fromRGB(255, 0, 55)
    ...
    bar.BackgroundColor3 = Color3.fromRGB(255, 0, 55)
    ...
    waterText.Font = Enum.Font.RobotoMono.Italic
    waterText.Text = text
...
function library:InitNotifications(text, duration, callback)
    ...
    function Notification:Notify(text, duration, type, callback)
        ...
        notifText.Font = Enum.Font.RobotoMono.Italic
        notifText.Text = text
...
function library:Introduction()
    ...
    xsxLogo.Image = "nil"
    xsxLogo.ImageColor3 = Color3.fromRGB(255, 0, 55)
    ...
    hashLogo.Image = "nil"
    hashLogo.ImageColor3 = Color3.fromRGB(255, 0, 55)
    ...
    xsx.Size = UDim2.new(0, 0, 0, 0)
    xsx.Font = Enum.Font.RobotoMono.Italic
    xsx.Text = "@evanaleda"
    ...
    text.Font = Enum.Font.RobotoMono.Italic
    text.Text = " "
    ...
    TweenService:Create(bar, TweenTable["introduction"], {Size = UDim2.new(0, 0, 0, 0)}):Play()
...
function library:Init(key)
    ...
    headerLabel.Font = Enum.Font.RobotoMono.Italic
    ...
    tabButtonsEdge.BackgroundColor3 = Color3.fromRGB(255, 0, 55)
    ...
    containerEdge.BackgroundColor3 = Color3.fromRGB(255, 0, 55)
    ...
    function TabLibrary:NewTab(title)
        ...
        tabButton.Font = Enum.Font.RobotoMono.Italic
        ...
        page.ScrollBarImageColor3 = Color3.fromRGB(255, 0, 55)
        page.Visible = false
        ...
        if TabLibrary.IsFirst then
            page.Visible = true
            tabButton.TextColor3 = Color3.fromRGB(255, 0, 55)
        ...
        tabButton.MouseButton1Click:Connect(function()
            ...
            TweenService:Create(tabButton, TweenTable["tab_text_colour"], {TextColor3 = Color3.fromRGB(255, 0, 55)}):Play()
        end)
        ...
        function Components:NewLabel(text, alignment)
            ...
            label.Font = Enum.Font.RobotoMono.Italic
            label.Text = text
        ...
        function Components:NewButton(text, callback)
            ...
            button.Font = Enum.Font.RobotoMono.Italic
            button.Text = ""
            ...
            buttonLabel.Font = Enum.Font.RobotoMono.Italic
            ...
            button.MouseButton1Down:Connect(function()
                TweenService:Create(buttonLabel, TweenTable["hover"], {TextColor3 = Color3.fromRGB(255, 0, 55)}):Play()
            end)
        ...
        function Components:NewSection(text)
            ...
            sectionLabel.Font = Enum.Font.RobotoMono.Italic
        ...
        function Components:NewToggle(text, default, callback)
            ...
            toggleButton.Font = Enum.Font.RobotoMono.Italic
            toggleButton.Text = ""
            ...
            toggleEdge.BackgroundColor3 = Color3.fromRGB(255, 0, 55)
            ...
            toggleDesignGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 0, 55)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 0, 55))}
            ...
            toggleLabel.Font = Enum.Font.RobotoMono.Italic
            ...
            function ToggleFunctions:AddKeybind(default_t)
                ...
                keybind.Font = Enum.Font.RobotoMono.Italic
                keybind.Text = ""
                ...
                keybindButtonLabel.Font = Enum.Font.RobotoMono.Italic
        ...
        function Components:NewKeybind(text, default, callback)
            ...
            keybindButton.Font = Enum.Font.RobotoMono.Italic
            keybindButton.Text = ""
            ...
            keybindLabel.Font = Enum.Font.RobotoMono.Italic
        ...
        function Components:NewTextbox(text, default, place, format, type, autoexec, autoclear, callback)
            ...
            if type == "small" then
                ...
                textBoxValues.Font = Enum.Font.RobotoMono.Italic
                ...
                textboxLabel.Font = Enum.Font.RobotoMono.Italic
                ...
                textBoxValues.Focused:Connect(function()
                    textBoxValues:GetPropertyChangedSignal("Text"):Connect(ResizeTextBox)
                    TweenService:Create(textbox, TweenTable["TextBox"], {BackgroundColor3 = Color3.fromRGB(255, 0, 55)}):Play()
                end)
        ...
        function Components:NewSelector(text, default, list, callback)
            ...
            selectorLabel.Font = Enum.Font.RobotoMono.Italic
            ...
            selector.Font = Enum.Font.RobotoMono.Italic
            selector.Text = ""
            ...
            selectorText.Font = Enum.Font.RobotoMono.Italic
            ...
            for i,v in next, list do
                ...
                optionButton.Font = Enum.Font.RobotoMono.Italic
                optionButton.Text = v
                optionButton.TextColor3 = Color3.fromRGB(255, 255, 255)
                optionButton.TextSize = 14.000
                if optionButton.Text == default then
                    optionButton.TextColor3 = Color3.fromRGB(255, 0, 55)
                ...
                optionButton.MouseButton1Click:Connect(function()
                    ...
                    TweenService:Create(optionButton, TweenTable["selector"], {TextColor3 = Color3.fromRGB(255, 0, 55)}):Play()
        ...
        function Components:NewSlider(text, suffix, compare, compareSign, values, callback)
            ...
            sliderIndicatorGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 0, 55)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 0, 55))}
            ...
            sliderLabel.Font = Enum.Font.RobotoMono.Italic
            ...
            sliderValue.Font = Enum.Font.RobotoMono.Italic
