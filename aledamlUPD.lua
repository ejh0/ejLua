...
function library:Watermark(text)
    ...
    waterText.Font = Enum.Font.RobotoMono
    waterText.Text = text
...
function library:Init(key)
    ...
    function TabLibrary:NewTab(title)
        ...
        function Components:NewButton(text, callback)
            ...
            button.Text = ""
            button.TextColor3 = Color3.fromRGB(255, 0, 55)
            ...
            buttonLabel.Font = Enum.Font.RobotoMono
            ...
            button.MouseEnter:Connect(function()
                TweenService:Create(button, TweenTable["hover"], {BackgroundColor3 = Color3.fromRGB(255, 0, 55)}):Play()
            end)
        ...
        function Components:NewToggle(text, default, callback)
            ...
            function ToggleFunctions:AddKeybind(default_t)
                ...
                keybindButtonLabel.Font = Enum.Font.RobotoMono
        ...
        function Components:NewTextbox(text, default, place, format, type, autoexec, autoclear, callback)
            ...
            if type == "small" then
                ...
                textBoxValues.Font = Enum.Font.RobotoMono
                ...
                textboxLabel.Font = Enum.Font.RobotoMono
        ...
        function Components:NewSelector(text, default, list, callback)
            ...
            selectorLabel.Font = Enum.Font.RobotoMono
            ...
            selector.Font = Enum.Font.RobotoMono
            selector.Text = ""
            ...
            selectorText.Font = Enum.Font.RobotoMono
        ...
        function Components:NewSlider(text, suffix, compare, compareSign, values, callback)
            ...
            sliderButton.Font = Enum.Font.RobotoMono
            sliderButton.Text = ""
